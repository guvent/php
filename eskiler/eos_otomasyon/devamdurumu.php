...
$sorgu2=mysqli_query($vt,"select * from devamsizlik where id=$id");
while($ogrenci2=mysqli_fetch_array($sorgu2))
	{  
	     
		$adDizi[]=$ogrenci2['dersAdi'];
		$basDizi[]=$ogrenci2['devamSaati'];
...
<ul id="menu">   
  ...
  <div class="iceriksol">
   	    <div class="icslDuyurular">
       	    <div>
       	      <h6><img src="img/takvim.png" width="1000" height="1000" />DEVAM DURUMU </h6>
       	    </div>
            ...
            <table width="95%" border="1" align="center" class="TabloForm">
              <tr>
                <td colspan="8" align="center" id="tablo"><div>DEVAMSIZLIK LİSTESİ </div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="13%" align="center"><div id="BAT">-Edilen Devamsızlık-</div></td>
                
              </tr>
              <tr>
                <td align="center"><div id="AKA1"><?php echo $adDizi[0]; ?></div></td>
                <td align="center"><div id="BAT1"><?php echo $basDizi[0]." Saat";?></div></td>
                
              </tr>
              <tr>
                <td align="center"><div id="AKA2"><?php echo $adDizi[1]; ?></div></td>
                <td align="center"><div id="BAT2"><?php echo $basDizi[1]." Saat";?></div></td>
                
              </tr>
              <tr>
                <td align="center"><div id="AKA3"><?php echo $adDizi[2]; ?></div></td>
                <td align="center"><div id="BAT3"><?php echo $basDizi[2]." Saat";?></div></td>
                
              </tr>
              <tr>
                <td align="center"><div id="AKA4"><?php echo $adDizi[3]; ?></div></td>
                <td align="center"><div id="BAT4"><?php echo $basDizi[3]." Saat";?></div></td>
                
              </tr>
			  <tr>
                <td align="center"><div id="AKA5"><?php echo $adDizi[4]; ?></div></td>
                <td align="center"><div id="BAT5"><?php echo $basDizi[4]." Saat";?></div></td>
                
              </tr>
			  <tr>
                <td align="center"><div id="AKA6"><?php echo $adDizi[5]; ?></div></td>
                <td align="center"><div id="BAT6"><?php echo $basDizi[5]." Saat";?></div></td>
               
              </tr>
			 
              <tr>
                <td colspan="8" align="center"><div id="uyari">-Devam Durumunu Dikkate Alınız. Aksi Taktirde Dersinizden Kalabilirsiniz-.</div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
