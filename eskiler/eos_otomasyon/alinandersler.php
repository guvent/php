...
$sorgu2=mysqli_query($vt,"select * from alinandersler where id=1");
while($ogrenci2=mysqli_fetch_array($sorgu2))
	{  
	     
		$adDizi[]=$ogrenci2['dersAdi'];
		$basDizi[]=$ogrenci2['dersHocasi'];
		$bitDizi[]=$ogrenci2['dersKredisi'];
...
<ul id="menu">   
  ...
  <div class="iceriksol">
   	    <div class="icslDuyurular">
       	    <div>
       	      <h6><img src="img/takvim.png" width="1000" height="1000" />ALINAN DERSLER </h6>
       	    </div>
            ...
            <table width="95%" border="1" align="center" class="TabloForm">
              <tr>
                <td colspan="8" align="center" id="tablo"><div>DERS LİSTESİ </div></td>
              </tr>
              <tr>
