...
global $basDizi;
global $bitDizi;
$sorgu2=mysqli_query($vt,"select * from akademiktakvimprogrami where id=1");
while($ogrenci2=mysqli_fetch_array($sorgu2))
	{  
	     
		$adDizi[]=$ogrenci2['aktiviteAdi'];
		$basDizi[]=$ogrenci2['aktiviteBaslamaTarihi'];
		$bitDizi[]=$ogrenci2['aktiviteBitisTarihi'];
...
<script src="javascript/akademiktakvim.js" language="javascript" type="text/javascript"></script>
...
<ul id="menu">   
  ...
  <div class="iceriksol">
   	    <div class="icslDuyurular">
       	    <div>
       	      <h6><img src="img/takvim.png" width="1000" height="1000" />AKADEMİK TAKVİM PROGRAMI</h6></div>
            ...
            <table width="95%" border="1" align="center" class="TabloForm">
              <tr>
                <td colspan="8" align="center" id="tablo"><div>AKADEMİK TAKVİM</div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="14%" align="center"><div id="AKA">-Aktivite Adı-</div></td>
                <td width="13%" align="center"><div id="BAT">-Başlama Tarihi-</div></td>
                <td width="12%" align="center"><div id="BIT">-Bitiş Tarihi-</div></td>
              ...
              <tr>
                ...
                <td align="center"><div id="BIT1"><?php echo $bitDizi[0];?></div></td>
              ...
              <tr>
                ...
                <td align="center"><div id="BIT2"><?php echo $bitDizi[1];?></div></td>
               
              </tr>
              <tr>                
                <td align="center"><div id="AKA3"><?php echo $adDizi[2]; ?></div></td>
                <td align="center"><div id="BAT3"><?php echo $basDizi[2];?></div></td>
                <td align="center"><div id="BIT3"><?php echo $bitDizi[2];?></div></td>         
              </tr>
              <tr>                
                <td align="center"><div id="AKA4"><?php echo $adDizi[3]; ?></div></td>
                <td align="center"><div id="BAT4"><?php echo $basDizi[3];?></div></td>
                <td align="center"><div id="BIT4"><?php echo $bitDizi[3];?></div></td>         
              </tr>
              <tr>
                <td colspan="8" align="center"><div id="uyari">Lütfen Aktivite Tarihlerine Dikkat Ediniz Aksatmayınız.</div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
